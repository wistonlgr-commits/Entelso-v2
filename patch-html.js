...
const htmlInjection = `</div>
        <div class="modal-footer">`;
const newHtml = `<div style="margin-top: 16px; padding-top: 16px; border-top: 1px solid var(--border);">
...
const lastIdx = content.lastIndexOf(htmlInjection);
if (lastIdx !== -1) {
  content = content.substring(0, lastIdx) + newHtml + content.substring(lastIdx + htmlInjection.length);
}
