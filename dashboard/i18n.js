...
const TRANSLATIONS = {
  en: {
    ...
    'inv.exportar':        'Export',
    'inv.exportar_qr':     'Export QR Labels',
    ...
    'modal.cerrar':        'Close',
    'modal.kit_contents':  'Kit Contents',
    'modal.add_item':      'Add Item',
    'modal.empty_kit':     'This kit is empty.',
    'modal.prompt_kit_serial': 'Enter the serial number of the asset to add to this kit:',
    'modal.err_not_found': 'Asset not found with that serial number.',
    'modal.err_already_in_kit': 'Asset is already in a kit.',
    'modal.confirm_remove_kit': 'Remove this asset from the kit?',
    ...
    'perfil.eliminar_foto': 'Remove Photo',
  ...
  es: {
    ...
    // ── Bulk Import (Forced English per user request) ──
    'import.titulo':       'Bulk Import Equipment',
    'inv.importar': 'Bulk Import',
    'import.desc':         'Upload an Excel (.xlsx) or CSV file to import multiple records at once. Please ensure your file matches the suggested format below.',
    'import.formato':      'Suggested Format (Headers)',
    ...
    'inv.exportar_qr':     'Exportar Etiquetas QR',
    ...
    'perfil.eliminar_foto': 'Eliminar Foto',
