...
html = html.replace(`                            <div class="dropdown-item" id="bulkMoveCategoryBtn" style="cursor:pointer; padding:10px 12px; display:flex; align-items:center; gap:8px; border-top: 1px solid var(--border);">
                                <i class="fa-solid fa-folder-tree"></i> <span data-i18n="bulk.mover_cat">Move Category</span>
                            </div>`, newDropdownItems);

const newModals = `<!-- Modal: Bulk Move to Category -->
...
const searchFor = `<!-- Modal: Bulk Move to Category -->
<div class="modal-overlay" id="bulkCategoryModal">
    <div class="modal" style="max-width: 400px;">
        <div class="modal-header">
            <h3 data-i18n="bulk.mover_cat">Move Category</h3>
...
if(html.includes(searchFor)) {
    html = html.replace(searchFor, newModals);
